...
module.exports = {
  ...
  async execute(client) {
    ...
    try {
      const partnershipSystem = new PartnershipSystem(client);
      await partnershipSystem.connect();
      await partnershipSystem.initDashboard();
      client.partnershipSystem = partnershipSystem;
      console.log("✅ Partnership System Active");
    } catch (err) { 
      console.error("❌ Partnership Module error:", err); 
    }
